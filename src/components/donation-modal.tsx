        ...
        {submitted ? (
          <div className="text-center py-12">
            ...
            <p className="mt-2 text-sm text-gray-500">
              Check your phone for the M-Pesa prompt to complete your donation.
            </p>
          </div>
        ) : (
          <>
            <div className="mb-6">
              ...
              <p className="text-gray-500">
                Your tithe and offerings support our mission and ministry.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="rounded-lg bg-blue-50 p-4 border border-blue-200">
                <p className="text-xs text-blue-700">
                  ...
                  M-Pesa PIN to complete the donation.
                </p>
              </div>

              <button
                type="submit"
                disabled={!amount.trim() || !phoneNumber.trim()}
              ...
              >
                {numAmount > 0 ? `Pay KSH ${numAmount.toLocaleString()} via M-Pesa` : "Enter amount"}
              </button>
            ...
            <p className="mt-4 text-center text-xs text-gray-500">
              Secure donation powered by M-Pesa
            </p>
          </>
        )}
      </div>
