              ...
              <div className="mt-10 space-y-8">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      <a href="tel:+15551234567" className="hover:text-primary-600 transition-colors no-underline text-gray-500">
                        (555) 123-4567
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      <a href="mailto:hello@gracechurch.org" className="hover:text-primary-600 transition-colors no-underline text-gray-500">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">
                      ...
                      <br />
                      Saturday & Sunday: Closed (services only)
                    </p>
                  </div>
                </div>
              </div>
